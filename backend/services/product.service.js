 ...
 * @param {{ sku: string, name: string, description?: string }} data Product data
 ...
 * @param {{ _id: string, sku: string, name: string, description?: string }} data The product data to update
